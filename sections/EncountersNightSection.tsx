...
export const EncountersNightSection: React.FC = () => (
  <div className="break-inside-avoid">
    <h4 className="text-3xl font-bold medieval-font text-black uppercase mb-4 border-l-[10px] border-stone-800 pl-4">Night: Inside Walls</h4>
    <table className="w-full text-left font-serif border-2 border-stone-800 shadow-sm">
      ...
      <tbody className="bg-white/80 text-sm">
        {VillageConstants.ENCOUNTERS_NIGHT_INSIDE.map((e, ei) => (
